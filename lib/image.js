 ...
 */
export async function generateImage({ title, summary, style = 'documentation' }) {
    const prompt = buildPrompt({ title, summary, style });
 ...
 */
function buildPrompt({ title, summary, style }) {
    const prompts = {
